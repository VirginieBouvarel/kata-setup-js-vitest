...
describe('FizzBuzz', () => {
   ...
   */ 
    ...
    /**
   * Question : 
   * On pourrait extraire number.tiString() dans une fonction aussi
   * pour garder un seul niveau d'abstraction
   * mais c'est peut-être too much, 
   * vu qu'on retournre une string dans tous les cas :
   * FIZZBUZZ, FIZZ, BUZZ ou 'number'
   */ 
